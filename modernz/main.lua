...
local get_chapter = _rendering.get_chapter
...
local setup_bg_elements = _layouts.setup_bg_elements
local get_speed_presets = _layouts.get_speed_presets
local layout_speed_menu = _layouts.layout_speed_menu
...
local bind_buttons = _osc_init.bind_buttons
local _events = require("modules.events")
local show_bar = _events.show_bar
local hide_bar = _events.hide_bar
local update_tracklist = _events.update_tracklist
local set_bar_visible = _events.set_bar_visible
...
local element_has_action = _events.element_has_action
local has_click_action = _events.has_click_action
local has_wheel_action = _events.has_wheel_action
local has_mid_action = _events.has_mid_action
local refresh_input_area = _events.refresh_input_area
local process_event = _events.process_event
local do_enable_keybindings = _events.do_enable_keybindings
local enable_osc = _events.enable_osc
local render = _events.render
local always_on = _events.always_on
